  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center max-w-5xl">
        ...
        <h1 className="font-heading text-4xl xs:text-5xl sm:text-7xl lg:text-8xl text-white leading-[0.95] mb-6 animate-fade-up">
          KAMPFSPORT &amp; FITNESS
          <br />
        ...
        <p className="text-base sm:text-xl text-white/80 max-w-xl mx-auto mb-8 font-body px-2">
        ...
        <div className="flex flex-col items-center gap-3 px-4 sm:px-0">
          <Button
            asChild
            size="lg"
            className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-white text-base sm:text-lg px-8 sm:px-12 py-5 sm:py-7 font-bold rounded-lg uppercase tracking-wide animate-pulse-glow shadow-[0_0_30px_hsl(355_72%_56%/0.4)]"
          >
            <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">
              Kostenloses Probetraining
            </a>
          </Button>
          <p className="text-white/60 text-xs sm:text-sm tracking-wide text-center">
